...
AGPL-3.0-only. First public GitHub source/runtime-tgz coordinate `0.1.0` is published at [inspr-at/aithema](https://github.com/inspr-at/aithema); `0.2.0` through `0.8.0` are also published and `0.9.0` is the prepared candidate in this increment. npm registry publication is not authorized.
