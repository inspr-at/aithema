 ...
 *   note: string,
 *   review_identity?: AcceptedRevisionReviewIdentity,
 * }} Decision
 */

/**
 * Deterministic consent identity. It binds the displayed review set, selected
 * proposal payload digests, and exact compared baseline revisions/digests.
 * @typedef {{
 *   review_digest: string,
 *   accepted_review_digest: string,
 *   selected_proposals: readonly { proposal_ref: string, proposal_digest: string }[],
 *   compared_baselines: readonly { baseline_ref: string, revision: number, content_digest: string }[],
 * }} AcceptedRevisionReviewIdentity
 */
